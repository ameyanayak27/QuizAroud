...
// Core Data methology Courtesy : Jameson Quave
//www.jamesonquave.com
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func preload(){
       ...
       let moc = self.managedObjectContext
        ...
        if let path = NSBundle.mainBundle().pathForResource("data", ofType: "plist") {
            //get array of questions from data.plist
             let myArray = NSMutableArray(contentsOfFile: path)! as Array
            //insert each question in core data
             for dict in myArray {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.QuizAround" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("QuizAround", withExtension: "momd")!
